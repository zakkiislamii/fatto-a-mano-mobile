...
export class PengajuanLemburRepository extends PengajuanRepository {
  private durasi_lembur: string = "";

  public setDurasiLembur(durasi_lembur: string): void {
    this.durasi_lembur = durasi_lembur;
  }

  public getDurasiLembur(): string {
    return this.durasi_lembur;
  }
  ...
  public async tambah(): Promise<void> {
    try {
      ...
      console.error("Error adding pengajuan lembur:", error);
      throw error;
    }
  }
